/*
  ...
  - You are about to alter the column `publicationDate` on the `Book` table. The data in that column could be lost. The data in that column will be cast from `Date` to `Date?`.
